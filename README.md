...
This ensures authentication, settings, Claude Code binary versions, Rust toolchains, Node.js
versions, and global npm packages persist across container restarts and image rebuilds.
